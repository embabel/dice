...
/**
 * Owns the stable evidence identity shared by provenance producers and consumers.
 *
 * Values are length-framed in a fixed field order. A length of `-1` represents null,
 * keeping absence distinct from every string value without escaping delimiters.
 */
